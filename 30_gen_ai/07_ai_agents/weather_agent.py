...
# This function allows the AI agent to execute terminal commands on the user's laptop.
...
# 🧠 Seems like user is interested in getting weather of Delhi in India
# 🧠 Lets see if we have any available tool from the list of available tools
# 🧠 Great, we have get_weather tool available for this query.
# 🧠 I need to call get_weather tool for delhi as input for city
# 🛠️: get_weather (delhi)
# 🛠️: get_weather (delhi) = The weather in delhi is Haze +28°C
# 🧠 Great, I got the weather info about delhi
# 🤖 The current weather in Delhi is 28°C with haze.