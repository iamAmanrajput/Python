...
# Update the current state with a new human message
# This changes the input from the previous request to a new request.
graph.update_state(
    thread,
    {
        "messages": [
            HumanMessage(content="No, please multiply 15 and 6")
        ]
    }
)
